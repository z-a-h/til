...
Define values to use in the rest of the template 
Can have any top level value 
...
Map of maps to be reused in the template, but that cannot be changed
Top level name can be whatever you want

```json
  "Mappings": {
    "AWSRegionECSAMI":{
      "us-east-1": { "ID" : "ami-83af8395" },
      "us-east-2": { "ID" : "ami-9f9cbafa" },
      "us-west-1": { "ID" : "ami-c1c6eba1" },
      "us-west-2": { "ID" : "ami-11120768" },
      "eu-west-1": { "ID" : "ami-5f140c39" },
      "eu-west-2": { "ID" : "ami-767e6812" },
      "eu-central-1": { "ID" : "ami-e656f189" },
      "ap-northeast-1": { "ID" : "ami-fd10059a" },
      "ap-southeast-1": { "ID" : "ami-1926ab7a" },
      "ap-southeast-2": { "ID" : "ami-6b6c7c08" },
      "ca-central-1": { "ID" : "ami-ead8678e" }
    }
  },

## Conditions

Also can be used throughout the template
Are handed functions to evaluate at runtime as a flag on some resources
